...
const Home = () => {
  return (
    <div className=" container  mx-auto flex md:flex-row items-center flex-col justify-between h-[734px] gap-10 mt-4 xl:mt-15">
      <div className="flex flex-col gap-5 xl:justify-center">
        <h1 className="text-[#211F54] lg:text-[68px] text-center md:text-left  text-[43px] w-full xl:max-w-[519px] max-w-[571px]  font-bold lg:leading-[72px] ">
          Quality cleaning for your home
        </h1>
        <p className="w-full max-w-[591px] lg:text-[21px] text-[15px] text-[#6E7191]  text-center md:text-left ">
        ...
        <div className="flex items-center justify-center md:justify-start">
          ...
          <div className="flex items-center">
            ...
            <span className=" sm:block md:text-[28px] text-[24px] hidden ">
              (414) 567 - 2109
            </span>
          </div>
        </div>
